...
if subgroup == "GCBcells":
	...
	"#6F8273", "#9F5196", "#DF6F32", "#FFA60F", "#FFF52F", "#CFA42D", "#B25C3F",
	"#E4779C", "#D28AB0", "#999999")
elif subgroup == "GCBcells_no_cycling":
	adata.uns["cell_type_colors"] = ("#984EA3", "#4DAF4A")
	adata.uns["seurat_cluster_colors"] = ("#E41A1C", "#596A98", "#449B75",
	"#6B886D", "#AC5782", "#FF7F00", "#FFE528", "#C9992C", "#C66764",
	"#E485B7", "#999999")
elif subgroup == "BCells_no_cycling":
	adata.uns["cell_type_colors"] = ("#377EB8", "#984EA3", "#4DAF4A",
	"#E41A1C", "#FF7F00")
	adata.uns["seurat_cluster_colors"] = ("#E41A1C", "#815375", "#3A85A8",
	"#46A169", "#629363", "#8D5B96", "#C4625D", "#FF7F00", "#FFC81D",
	"#F2E631", "#BF862B", "#BD6253", "#EB7AA9", "#CE8BAE", "#999999")
